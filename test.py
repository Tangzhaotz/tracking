...
def main():
    ...
    dataset_root = os.path.join(cur_dir, '/home/UserDirectory/tangz/Datasets/OTB/OTB100', args.dataset)
    #dataset_root = os.path.join(cur_dir, 'home/UserDirectory/tangz/Datasets/UAV123/UAV123', args.dataset)
